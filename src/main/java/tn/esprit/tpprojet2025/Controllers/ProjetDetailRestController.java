...
public class ProjetDetailRestController {
    ...
    @GetMapping("/getProjetDetailsByTechnologie/{techno}")
    List<ProjetDetail> getProjetDetailsByTechnologie(@PathVariable("techno") String technologie) {
        return projetDetailServices.findByTechnologieContains(technologie);
    }
}
