...
public class ProjetRestController {
    ...
    @GetMapping("/getProjetsByCoutAndTechnologie/{technologie}/{cout}")
    List<Projet> getProjetsByCoutAndTechnologie(@PathVariable("technologie") String technologie,
                                                @PathVariable("cout") Long cout){
        return projetServices.retrieveProjetsByCoutAndTechnologie(technologie, cout);}
