...
public class EquipeRestController {
    ...
    @GetMapping("/getEquipesByProjetTechnologie/{technologie}")
    List<Equipe> getEquipesByProjetTechnologie(@PathVariable("technologie") String technologie) {
        return equipeService.retrieveEquipesByProjetTechnologie(technologie);}
}
