...
public class EntrepriseServicesImpl implements IEntrepriseServices {
    ...
    public List<Entreprise> retrieveEntreprisesByAdresse(String adresse) {
        return entrepriseRepository.findByadresseEntreprise(adresse); }
    @Override
    public List<Entreprise> retrieveEntreprisesBySpecialiteEquipe(String specialite) {
        return entrepriseRepository.retrieveEntreprisesBySpecialiteEquipe(specialite);}
    @Override
    public int updateEntrepriseByAdresse(String adresse, Long idEntreprise) {
        return entrepriseRepository.updateEntrepriseByAdresse(adresse,idEntreprise);}
    @Override
    public int deleteEntrepriseByAdresse(String adresse) {
        return entrepriseRepository.deleteEntrepriseByAdresse(adresse);}
}
